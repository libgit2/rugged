...
class RepositoryPushTest < Rugged::TestCase
  ...
  def test_push_to_non_bare_raise_error
    ...
    assert_equal "Local push doesn't (yet) support pushing to non-bare repos.".b, exception.message
  end
  ...
  def test_push_non_forward_raise_error
    ...
    assert_equal "Cannot push non-fastforwardable reference".b, exception.message
